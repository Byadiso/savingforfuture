...
export const fetchFilteredTransactions = async (filterType, searchTerm, setData) => {
    let dateRange;
    ...
    try {
      ...
      const filteredTransactions = allTransactions.filter(transaction => {
        const matchesDate = dateRange ? 
                            new Date(transaction.createdAt) >= dateRange.start && new Date(transaction.createdAt) <= dateRange.end :
